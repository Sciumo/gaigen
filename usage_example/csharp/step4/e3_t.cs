...
using System;
namespace c3ga_ns {
/// <summary>This class can hold a specialized multivector of type e3_t.
/// 
...
/// 
/// </summary>
public class e3_t  :  mv_if
{ 
	/// <summary>Array indices of e3_t coordinates.
	/// </summary>
	...
	public e3_t(mv A /*, int filler */) {Set(A);}


    /// <summary>
	/// Implicit converter from e3_t to mv.
    /// </summary>
    public static implicit operator mv(e3_t a)
    {
        return new mv(a);
    }
...
public void Set(e3_t a)
{
	...
	/// </summary>
	public float get_e3() { return 1.0f;}

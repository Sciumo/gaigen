...
using System;
namespace c3ga_ns {
/// <summary>This class can hold a specialized multivector of type no_t.
/// 
...
/// 
/// </summary>
public class no_t  :  mv_if
{ 
	/// <summary>Array indices of no_t coordinates.
	/// </summary>
	...
	public no_t(mv A /*, int filler */) {Set(A);}


    /// <summary>
	/// Implicit converter from no_t to mv.
    /// </summary>
    public static implicit operator mv(no_t a)
    {
        return new mv(a);
    }

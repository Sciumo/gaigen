...
using System;
namespace c3ga_ns {
/// <summary>This class can hold a specialized multivector of type e2_t.
/// 
...
/// 
/// </summary>
public class e2_t  :  mv_if
{ 
	/// <summary>Array indices of e2_t coordinates.
	/// </summary>
	...
	public e2_t(mv A /*, int filler */) {Set(A);}


    /// <summary>
	/// Implicit converter from e2_t to mv.
    /// </summary>
    public static implicit operator mv(e2_t a)
    {
        return new mv(a);
    }
...
public void Set(e2_t a)
{
	...
	/// </summary>
	public float get_e2() { return 1.0f;}

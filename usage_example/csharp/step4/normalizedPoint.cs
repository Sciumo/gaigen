...
public void Set(normalizedPoint a)
{
	...
	/// </summary>
	public static pointPair operator ^(normalizedPoint a, normalizedPoint b) {
		return c3ga.op(a, b);
	}
	...
	/// <summary>operator for c3ga.op(a, b)
	/// </summary>
	public static flatPoint operator ^(normalizedPoint a, ni_t b) {
		return c3ga.op(a, b);
	}
	...
	/// <summary>operator for c3ga.op(a, b)
	/// </summary>
	public static line operator ^(normalizedPoint a, flatPoint b) {
		return c3ga.op(a, b);
	}
	...
	/// <summary>operator for c3ga.op(a, b)
	/// </summary>
	public static plane operator ^(normalizedPoint a, line b) {
		return c3ga.op(a, b);
	}

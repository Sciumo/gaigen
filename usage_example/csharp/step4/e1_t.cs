...
using System;
namespace c3ga_ns {
/// <summary>This class can hold a specialized multivector of type e1_t.
/// 
...
/// 
/// </summary>
public class e1_t  :  mv_if
{ 
	/// <summary>Array indices of e1_t coordinates.
	/// </summary>
	...
	public e1_t(mv A /*, int filler */) {Set(A);}


    /// <summary>
	/// Implicit converter from e1_t to mv.
    /// </summary>
    public static implicit operator mv(e1_t a)
    {
        return new mv(a);
    }
...
public void Set(e1_t a)
{
	...
	/// </summary>
	public float get_e1() { return 1.0f;}

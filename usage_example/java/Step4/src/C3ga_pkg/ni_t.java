 ...
 * 
 */
public class ni_t  implements  Mv_if
{ 
	/**
    ...
    /** Copy constructor. */
	public ni_t(final ni_t A) {set(A);}
	 ...
	 */
	public ni_t(final Mv A /*, final int filler */) {set(A);}
...
public final void set(final ni_t a)
{
	 ...
	 */
	public final float get_ni() { return 1.0f;}
	/**

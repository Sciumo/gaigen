...
{
	SmvType type_a = a.to_Mv().m_t;
	SmvType type_b = b.to_Mv().m_t;
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0) && 
		(type_b.compareTo(SmvType.C3GA_MV) > 0) && (type_b.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"add\" arg1=\""+ typenames[type_a.getId()] + "\" arg2=\""+ typenames[type_b.getId()] + "\"/>";
...
public final static Mv subtract(final Mv_if a, final Mv_if b)
{
	...
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0) && 
		(type_b.compareTo(SmvType.C3GA_MV) > 0) && (type_b.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"subtract\" arg1=\""+ typenames[type_a.getId()] + "\" arg2=\""+ typenames[type_b.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float[][] ac = a.to_Mv().c();
	float[][] bc = b.to_Mv().c();
...
public final static Mv negate(final Mv_if a)
{
	SmvType type_a = a.to_Mv().m_t;
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"negate\" arg1=\""+ typenames[type_a.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float[][] ac = a.to_Mv().c();
	float[][] cc = new float[6][];
...
public final static Mv reverse(final Mv_if a)
{
	SmvType type_a = a.to_Mv().m_t;
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"reverse\" arg1=\""+ typenames[type_a.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float[][] ac = a.to_Mv().c();
	float[][] cc = new float[6][];
...
public final static Mv gradeInvolution(final Mv_if a)
{
	SmvType type_a = a.to_Mv().m_t;
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"gradeInvolution\" arg1=\""+ typenames[type_a.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float[][] ac = a.to_Mv().c();
	float[][] cc = new float[6][];
...
public final static Mv cliffordConjugate(final Mv_if a)
{
	SmvType type_a = a.to_Mv().m_t;
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"cliffordConjugate\" arg1=\""+ typenames[type_a.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float[][] ac = a.to_Mv().c();
	float[][] cc = new float[6][];
...
public final static Mv gp(final Mv_if a, final Mv_if b)
{
	...
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0) && 
		(type_b.compareTo(SmvType.C3GA_MV) > 0) && (type_b.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"gp\" arg1=\""+ typenames[type_a.getId()] + "\" arg2=\""+ typenames[type_b.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float[][] ac = a.to_Mv().c();
	float[][] bc = b.to_Mv().c();
...
public final static Mv op(final Mv_if a, final Mv_if b)
{
	...
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0) && 
		(type_b.compareTo(SmvType.C3GA_MV) > 0) && (type_b.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"op\" arg1=\""+ typenames[type_a.getId()] + "\" arg2=\""+ typenames[type_b.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float[][] ac = a.to_Mv().c();
	float[][] bc = b.to_Mv().c();
...
public final static float sp(final Mv_if a, final Mv_if b)
{
	...
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0) && 
		(type_b.compareTo(SmvType.C3GA_MV) > 0) && (type_b.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"sp\" arg1=\""+ typenames[type_a.getId()] + "\" arg2=\""+ typenames[type_b.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float[][] ac = a.to_Mv().c();
	float[][] bc = b.to_Mv().c();
...
public final static Mv mhip(final Mv_if a, final Mv_if b)
{
	...
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0) && 
		(type_b.compareTo(SmvType.C3GA_MV) > 0) && (type_b.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"mhip\" arg1=\""+ typenames[type_a.getId()] + "\" arg2=\""+ typenames[type_b.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float[][] ac = a.to_Mv().c();
	float[][] bc = b.to_Mv().c();
...
public final static Mv lc(final Mv_if a, final Mv_if b)
{
	...
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0) && 
		(type_b.compareTo(SmvType.C3GA_MV) > 0) && (type_b.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"lc\" arg1=\""+ typenames[type_a.getId()] + "\" arg2=\""+ typenames[type_b.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float[][] ac = a.to_Mv().c();
	float[][] bc = b.to_Mv().c();
...
public final static float norm(final Mv_if a)
{
	SmvType type_a = a.to_Mv().m_t;
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"norm\" arg1=\""+ typenames[type_a.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float n2 = 0.0f;
	float[] c = new float[1];
...
public final static Mv unit(final Mv_if a)
{
	SmvType type_a = a.to_Mv().m_t;
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"unit\" arg1=\""+ typenames[type_a.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
...
public final static Mv applyVersor(final Mv_if a, final Mv_if b)
{
	...
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0) && 
		(type_b.compareTo(SmvType.C3GA_MV) > 0) && (type_b.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"applyVersor\" arg1=\""+ typenames[type_a.getId()] + "\" arg2=\""+ typenames[type_b.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
...
public final static Mv applyUnitVersor(final Mv_if a, final Mv_if b)
{
	...
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0) && 
		(type_b.compareTo(SmvType.C3GA_MV) > 0) && (type_b.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"applyUnitVersor\" arg1=\""+ typenames[type_a.getId()] + "\" arg2=\""+ typenames[type_b.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
...
public final static Mv versorInverse(final Mv_if a)
{
	SmvType type_a = a.to_Mv().m_t;
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"versorInverse\" arg1=\""+ typenames[type_a.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
...
public final static Mv dual(final Mv_if a)
{
	SmvType type_a = a.to_Mv().m_t;
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"dual\" arg1=\""+ typenames[type_a.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float[][] ac = a.to_Mv().c();
	float[][] cc = new float[6][];
...
public final static Mv undual(final Mv_if a)
{
	SmvType type_a = a.to_Mv().m_t;
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"undual\" arg1=\""+ typenames[type_a.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float[][] ac = a.to_Mv().c();
	float[][] cc = new float[6][];
...
public final static float norm2(final Mv_if a)
{
	SmvType type_a = a.to_Mv().m_t;
	if ((type_a.compareTo(SmvType.C3GA_MV) > 0) && (type_a.compareTo(SmvType.C3GA_INVALID) < 0)) {
			String reportUsageString = "<function name=\"norm2\" arg1=\""+ typenames[type_a.getId()] + "\"/>";
			ReportUsage.mergeReport(new ReportUsage(reportUsageString));
	}
	float n2 = 0.0f;
	float[] c = new float[1];

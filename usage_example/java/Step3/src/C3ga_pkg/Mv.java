...
{ 
	...
	protected SmvType m_t = SmvType.C3GA_NONE; 
	...
	* Constructs a new Mv with value 0.
	...
	public void set(NormalizedPoint src) {
		...
		ptr[3] = src.m_c[2];
		ptr[4] = src.m_c[3];
		m_t = SmvType.C3GA_NORMALIZEDPOINT;
	}

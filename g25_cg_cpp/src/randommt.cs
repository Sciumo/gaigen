        ...
        namespace CPP
        {
            ...
            class RandomMT
            {
                ...
                public static List<string> GenerateCode(Specification S, G25.CG.Shared.CGdata cgd)
                {
                    ...
                    string headerFilename = S.GetOutputPath(GetRawMtHeaderFilename(S));
                    string sourceFilename = S.GetOutputPath(GetRawMtSourceFilename(S));

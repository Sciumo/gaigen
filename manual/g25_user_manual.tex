...
Computes the versor inverse of a multivector ($\frac{\gav{X}}{\gav{X}\rev{\gav{X}}}$). 
...
Check whether a multivector is zero, up to a scalar epsilon (difference threshold) value.
\begin{verbatim}

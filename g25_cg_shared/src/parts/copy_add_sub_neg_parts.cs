                    ...
                    for (int g = 0; g < nbGroups; g++)
                    {
                        ...
                        switch (T)
                        {
                            ...
                            case UnaryToggleSignType.REVERSE:
                                neg = (gmv.Group(g)[0].Reverse().scale / gmv.Group(g)[0].scale) < 0;
                                break;
                            case UnaryToggleSignType.GRADE_INVOLUTION:
                                neg = (gmv.Group(g)[0].GradeInvolution().scale / gmv.Group(g)[0].scale) < 0;
                                break;
                            case UnaryToggleSignType.CLIFFORD_CONJUGATE:
                                neg = (gmv.Group(g)[0].CliffordConjugate().scale / gmv.Group(g)[0].scale) < 0;
                                break;
                        }
